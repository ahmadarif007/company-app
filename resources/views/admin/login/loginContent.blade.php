                            ...
                            <form role="form" method="POST" action="{{url('/login')}}">
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="E-mail" name="email" type="email" autofocus>
                                    ...
                                    <div class="form-group">
                                        <input class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Password" name="password" type="password" value="">
                                    ...
                                    <div>
                                        <button class="btn btn-block btn-success" name="btn" type="submit">Submit</button>
